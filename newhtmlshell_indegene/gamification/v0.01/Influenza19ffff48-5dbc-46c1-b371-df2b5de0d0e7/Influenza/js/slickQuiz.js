...
var field = document.getElementById("foo"),
	...
	set('cmi.core.score.max', metervalue);  
	set('cmi.core.score.raw', metervalue); 
	//set('cmi.objectives.n.score._children', score); 
    var getscore =  scorm.get('cmi.core.score.raw');
    $(".value").text(getmetervalue);
    //console.log(totalQuestionpush);
...
(function($){
    $.slickQuiz = function(element, options) {
        ...
        var maxmeterval = 185;
        var meterunit = maxmeterval/questionCount;
                        ...
                        for (i in answers) {
                            if (answers.hasOwnProperty(i)) {
                                ...
                                var input = '<input id="' + optionId + '" name="' + inputName +
                                            '" type="' + inputType + '" class="hidewarning with-gap filled-in" />';
var optionLabel = '<label class="hidewarning" id="' + optionId + '" for="' + optionId + '"><p class="parag" id="' + optionId + '"><figure class="ball bubble" id="' + optionId + '"></figure><p class="param">' + answer.option + '</p></p></label>';
            ...
            checkAnswer: function(checkButton) {
                ...
                answerInputs.each( function() {
                    ...
                    $(".answers").children().attr("class","wantdisable");
					 $(".wantdisable").children().attr("disabled","disabled");
                  
                });

                if (plugin.config.preventUnanswered && selectedAnswers.length === 0) {
                     $(".messagearea").show();
                    $(".messagearea").html('<p>You must select at least one answer.</p>');
                    return false;
                }

                // Verify all/any true answers (and no false ones) were submitted
                var correctResponse = plugin.method.compareAnswers(trueAnswers, selectedAnswers, selectAny);
                // Area to add ur point
                if (correctResponse) {
                    questionLI.addClass(correctClass);
                    //alert(5);
                      reward+=5;
                  maxmeterval-= 21.25;
                 finalmeter = maxmeterval;
                  $(".foo").val(finalmeter);
                    changevalue();
                      $(".getreward").val(reward);
                      send_points();
                    send_meter();
        ...
        plugin.init = function() {
            ...
            $(_element + ' ' + _nextQuestionBtn).on('click', function(e) {
                ...
                plugin.method.nextQuestion(this);
                 //$(".answers").children().removeAttr("class","wantdisable");
                  $(".wantdisable").children().removeAttr("disabled","disabled");
                $(".ball").show();
            });
            $("#question1_0").bind("click",function(){
             $("#question1_0 > .ball").toggleClass("activeball");
            $("#question1_1 > .ball").removeClass("activeball");
            }); 
            $("#question1_1").bind("click",function(){
             $("#question1_1 > .ball").toggleClass("activeball");
              $("#question1_0 > .ball").removeClass("activeball");
            });
            $(".hidewarning").bind("click",function(){
