...
function get(param){
    ...
    var bookmarkedpage = "page"+value+".html";
    ...
    $(".launchbox").hide();
     $(".audio-pause").css({
      ...
      $(".nis_frame_emod").load(bookmarkedpage, function(response, status, xhr) {
                          ...
                          //chapterViewed(frame);
          $(".launch").hide();
            $("#audio-slideshow").attr("data-audio", "audio/f" + value + ".mp3");
                      $("audio").attr("src", "audio/f" + value + ".mp3");
...
window.onload = function (){
	init();
    showbookmarkpopup('cmi.suspend_data'); 
    return false;
}
              ...
              $playButton.click(function(event) {
                ...
                $(".audio-pause").addClass("block");
                  ...
                  $nextButton.bind("click", function(event) {
                      ...
                      if(($(trackframes).length) == totalframe_tracker.length)
                      {
