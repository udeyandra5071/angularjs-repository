...
function send_avatar(){
  ...
  setavatar = value;
	set('cmi.interactions.n.student_response', setavatar);  
      ...
      $.fn.udSynch = function(options) {
        ...
        //End of enabling button//
                  ...
                  console.log(pass_status);
                   ...
                   $('#optionbox').openModal();
                   var getavatar_id = scorm.get('cmi.interactions.n.student_response');
                  console.log("get av av value "+getavatar_id);
                   $("#avatar").html("<img src='avatars/"+getavatar_id+".png' />");
                      // swiper//
