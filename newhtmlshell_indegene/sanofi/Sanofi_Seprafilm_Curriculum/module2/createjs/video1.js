...
p.nominalBounds = new cjs.Rectangle(275,274.5,540.5,530.8);
...
(lib.background = function() {
	...
	// Layer 1
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().ls(["rgba(255,255,255,0)","#FFFFFF","rgba(255,255,255,0)"],[0,0.557,1],-292.5,19.5,292.6,19.5).ss(1,1,1).p("EAtoAAAMhafAAAIgwAA");
	this.shape_1.setTransform(0,-31.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().ls(["rgba(255,255,255,0)","#FFFFFF","rgba(255,255,255,0)"],[0,0.557,1],-327.1,147.6,327.2,147.6).ss(1,1,1).p("EgtnAAAIAwAAMBafAAA");
	this.shape_2.setTransform(0,-147.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#FFFFFF").ss(1,1,1).p("AAEAAIgHAA");
	this.shape_3.setTransform(-292.5,-308.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.lf(["rgba(255,255,255,0)","rgba(209,140,37,0.702)","rgba(251,174,23,0)"],[0,0.6,1],-211,-88.3,167.9,-88.3).s().p("EAs4AJDMhafAAAIAAyFMBafAAAIAwAAIAASFg");
	this.shape_4.setTransform(4.8,-89.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.lf(["rgba(252,248,243,0)","rgba(224,177,106,0.541)","rgba(255,255,255,0)","#FFFFFF","#FFFFFF"],[0,0.533,1,1,1],-197,26.5,167.9,26.5).s().p("EgtnAMJIAAgFIAA4MMBbMAAAIADAAIAAYMIAAAFg");
	this.shape_5.setTransform(0.3,202.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.lf(["rgba(255,255,255,0)","rgba(111,136,113,0.702)","rgba(251,174,23,0)"],[0,0.6,1],-199.1,26.5,170.1,26.5).s().p("EgtnAMJIAAgFIAA4MIAwAAMBafAAAIAAYMIAAAFg");
	this.shape_6.setTransform(0,46.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#F9E2C3").s().p("EgtkAACIgDAAIAAgDMBbPAAAIAAADg");
	this.shape_7.setTransform(0,124.3);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.lf(["rgba(255,255,255,0)","rgba(228,76,22,0.702)","rgba(251,174,23,0)"],[0,0.6,1],-212,46.7,166.9,46.7).s().p("Egs3AMlIgwAAIAA5IMBbPAAAIAAZIg");
	this.shape_8.setTransform(0,-228);

	this.addChild(this.shape_8,this.shape_7,this.shape_6,this.shape_5,this.shape_4,this.shape_3,this.shape_2,this.shape_1,this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-294,-309.5,590.9,589.6);
...
(lib.animation = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1227).to({_off:false},0).to({_off:true},7).wait(181));
	...
	this.instance_1.setTransform(399.9,46.2);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(4).to({_off:false},0).wait(1411));

	// Layer 46
	this.instance_2 = new lib.background("synched",0);
	this.instance_2.setTransform(507.5,327.9);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({_off:false},0).wait(1414));
