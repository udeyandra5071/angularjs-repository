	...
	$.fn.audioSlideshowTab2 = function( options ) {
		...
		return this.each(function () {
			...
			$playButton_tabtwo.click(function(event){
				$jPlayerObj_tabtwo.jPlayer("play");
				$('.audio-slideshow-tab2').css({"width":"1024px","height":"570px"});
					$playButton_tabtwo.css({"width":"25px","height":"25px"});
						$pauseButton_tabtwo.css({"width":"25px","height":"25px"});
							$(".audio-control-interface-tab2").css({"bottom":"7px","position":"absolute"});
												  ...
												  $(this).addClass("play-icon");
													 $pauseButton_tabtwo.addClass("pause-icon");
													  $(".jp-stop_2").addClass("close-icon");
														 $(".tab-box2").css({"left":"-34px","top":"42px"});
														  $(".timeline").hide();
															 $(".tab-box1").hide();
															   $(".tab-box3").hide();
																  $(this).css({"left":"96px","top":"24px"});	
															     $pauseButton_tabtwo.css({"left":"96px","top":"24px"});
																	  $(".audio-play").hide();
				                  			     $(".audio-pause").hide();
										   ...
										   $pauseButton_tabtwo.removeClass("pause-icon");
											  $playButton_tabtwo.removeClass("play-icon");
												 $(".timeline").show();
												  $(".tab-box1").show();
														$(".tab-box3").show();
														 $(".tab-box2").css({"left":"98px","top":"48px"});
														  $(".audio-play").show();
				                  			$(".audio-pause").show();
																   $(".audio-play").removeClass("z-index_oldplayicon");
																		    $(".audio-pause").removeClass("z-index_oldplayicon");
																				 $playButton_tabtwo.css({"left":"0px","top":"0px"});
														   						 $pauseButton_tabtwo.css({"left":"0px","top":"0px"});
																					  $playButton_tabtwo.hide();
																					    $pauseButton_tabtwo.hide();
