    ...
    "questions": [
        { // Question 1 - Multiple Choice, Single True Answer
            ...
            "a": [
                ...
                {"option": "Yes, because Sam is relatively new to the organisation, James can take him along to the meeting to introduce him to the physicians and Sam can then use this opportunity to talk to them about Product X.",     "correct": false},
                {"option": "No, it is not acceptable for Sam to attend the meeting and promote Ipsen’s product, because a non-promotional meeting organised by MSLs with HCPs (be it individual or collective) in the presence of a sales representative is prohibited and can be done only for the purpose of making an introduction.",      "correct": true},
