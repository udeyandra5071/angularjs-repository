...
function send(){
	...
	trackframe.push(value);
	
	set('cmi.suspend_data', trackframe);

}


function set(param, trackframe){

	show("Sending: '" +trackframe +"'");

	var callSucceeded = scorm.set(param, trackframe);
              ...
              $playButton.click(function(event) {
                ...
                $(".audio-pause").addClass("block");
                  ...
                  $nextButton.bind("click", function(event) {
                      ...
                      trackframes.push(num);
                      if(($(trackframes).size()) == totalframe_tracker)
                      {
