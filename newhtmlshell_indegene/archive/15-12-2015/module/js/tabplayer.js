...
$("#tabv2_1").bind("click",function(){
  $(this).addClass("activex_6");
   $("#tabv2_2").removeClass("activex_5");
    $("#tabv2_3").removeClass("activex_4");
	 $("#tabv2_4").removeClass("activex_3");
       $("#tabv2_5").removeClass("activex_2");
	     $("#tabv2_6").removeClass("activex_1");
  ...
  $("#tabv2_1").removeClass("activex_6");
   $("#tabv2_2").removeClass("activex_5");
    $("#tabv2_3").removeClass("activex_4");
	 ...
	 $("#tabv2_5").removeClass("activex_2");
 $(".nis_frame_tabMode").fadeIn();	 
    $(".nis_frame_tabMode").load(tab2_6, function( response, status, xhr ) {
			if ( status == "error" ) {
			     var msg = "Sorry no page found ";alert( msg + xhr.status + " " + xhr.statusText );location.reload();
									}
				$(".audio-pause").show();
