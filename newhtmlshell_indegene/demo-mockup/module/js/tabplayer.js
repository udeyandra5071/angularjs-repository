...
$("#tab1").bind("click",function(){
   $(".tab-container-box").load(tab1, function( response, status, xhr ) {
			if ( status == "error" ) {
...
$("#tab2").bind("click",function(){
   ...
   $(".tab-container-box").load(tab2, function( response, status, xhr ) {
			if ( status == "error" ) {
			     var msg = "Sorry no page found ";alert( msg + xhr.status + " " + xhr.statusText );location.reload();
									}
				$(".audio-pause").show();
...
$("#tab3").bind("click",function(){
   $(".tab-container-box").load(tab3, function( response, status, xhr ) {
			if ( status == "error" ) {
			     var msg = "Sorry no page found ";alert( msg + xhr.status + " " + xhr.statusText );location.reload();
									}
				$(".audio-pause").show();
...
//  Tab feature V2//
var tabv2_1="page3a.html"; var tab2_2="page3b.html"; var tab2_3="page3c.html"; var tab2_4="page3d.html";var tab2_5="page3e.html";var tab2_6="page3f.html";
$("#tabv2_1").bind("click",function(){
  $(this).addClass("activex_1");
   $("#tabv2_2").removeClass("activex_2");
    ...
    $(".progress").show();
   $(".tab-container-box").load(tabv2_1, function( response, status, xhr ) {
			if ( status == "error" ) {
			     var msg = "Sorry no page found ";alert( msg + xhr.status + " " + xhr.statusText );location.reload();
									}
        $(".progress").hide();
 ...
 $(this).addClass("activex_2");
  $("#tabv2_1").removeClass("activex_1");
   ...
   $("#tabv2_6").removeClass("activex_6");
    ...
    $(".progress").show();
   $(".tab-container-box").load(tab2_2, function( response, status, xhr ) {
			if ( status == "error" ) {
			     var msg = "Sorry no page found ";alert( msg + xhr.status + " " + xhr.statusText );location.reload();
				$(".progress").hide();					}
				$(".audio-pause").show();
 ...
 $(this).addClass("activex_3");
  $("#tabv2_1").removeClass("activex_1");
   ...
   $("#tabv2_5").removeClass("activex_5");  
    ...
    $(".nis_frame_tabMode").fadeIn();
    $(".progress").show();
    $(".tab-container-box").load(tab2_3, function( response, status, xhr ) {
			if ( status == "error" ) {
			     var msg = "Sorry no page found ";alert( msg + xhr.status + " " + xhr.statusText );location.reload();
									}
        $(".progress").hide();
   ...
   $("#tabv2_2").removeClass("activex_2");
    $("#tabv2_3").removeClass("activex_3");
     $("#tabv2_5").removeClass("activex_5");
	  ...
	  $(".nis_frame_tabMode").fadeIn();
    $(".progress").show();
    $(".tab-container-box").load(tab2_4, function( response, status, xhr ) {
			if ( status == "error" ) {
			     var msg = "Sorry no page found ";alert( msg + xhr.status + " " + xhr.statusText );location.reload();
									}
        $(".progress").hide();
...
$("#tabv2_5").bind("click",function(){
 ...
 $(".nis_frame_tabMode").fadeIn();	
    $(".progress").hide();
    $(".tab-container-box").load(tab2_5, function( response, status, xhr ) {
			if ( status == "error" ) {
			     var msg = "Sorry no page found ";alert( msg + xhr.status + " " + xhr.statusText );location.reload();
									}
        $(".progress").hide();
...
$("#tabv2_6").bind("click",function(){
 ...
 $(".nis_frame_tabMode").fadeIn();	
    $(".progress").show();
    $(".tab-container-box").load(tab2_6, function( response, status, xhr ) {
			if ( status == "error" ) {
			     var msg = "Sorry no page found ";alert( msg + xhr.status + " " + xhr.statusText );location.reload();
									}
        $(".progress").hide();
