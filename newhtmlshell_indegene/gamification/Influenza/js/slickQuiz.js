...
(function($){
    $.slickQuiz = function(element, options) {
        ...
        maxmeterval = $(".foo").val();
        meterunit = maxmeterval/questionCount;
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        if (plugin.config.disableResponseMessaging || plugin.config.completionResponseMessaging) {
                            questionHTML.append('<a href="#" class="button hide ' + nextQuestionClass + ' ' + checkAnswerClass + '">' + plugin.config.nextQuestionText + '</a>');
                        } else {
                            questionHTML.append('<a href="#" class="button hide ' + nextQuestionClass + '">' + plugin.config.nextQuestionText + '</a>');
