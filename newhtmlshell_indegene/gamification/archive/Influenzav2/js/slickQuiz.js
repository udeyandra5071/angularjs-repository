...
(function($){
    $.slickQuiz = function(element, options) {
        ...
        var maxsugarlevel = 220;
        var minsugarlevel = 90;
        var acutalsugarlevelH1 = (maxsugarlevel/questionCount)/10;
        var acutalsugarlevelH2 = (minsugarlevel/questionCount)/10;
        var defaultmeterval = $(".range").val();
        console.log(acutalsugarlevelH1);
        console.log(acutalsugarlevelH2);
                    ...
                    if (questions.hasOwnProperty(i)) {
                        ...
                        for (i in answers) {
                            if (answers.hasOwnProperty(i)) {
                                ...
                                var optionLabel = '<label class="hidewarning" for="' + optionId + '">' + answer.option + '</label>';
            ...
            checkAnswer: function(checkButton) {
                ...
                if (correctResponse) {
                    ...
                    //alert(5);
                     ...
                     maxsugarlevel -= 5;
                    $(".range").val(maxsugarlevel);
                    $(".metervalue").text(maxsugarlevel);
                    send_points();
