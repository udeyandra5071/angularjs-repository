  ...
  //    $(".modal-close").bind("click",function(){
       ...
       //   });
			...
			$("#responsive-icon").bind("click",function(){
                $(".menu-box").toggle("slide", 280 );
                $(".nis_frame_emod").toggleClass("move-left");
                 $(".tableof_content").hide();
                 $(".helpindex").hide();
				 ...
				 /*$("#moduleclose-icon").bind("click",function(){
                     $("#resourceloader").hide();
                      $(".close_resources").hide();
                     $(".menu-box").show();
					  	$(".menu-box").css({"z-index":"-1"}).animate({"z-index":"-1"},600);
      ...
      $(".audiotranscriptor").bind("click", function() {
          ...
          $(".transcript_loader").toggle("slide",250);
      ...
      $(".tableindex").bind("click", function() {
          $(".close_resources").hide();
          $("#resourceloader").hide();
          $(".tableof_content").toggle("slide",250);
          $(".audio-play").show();      
          $(".audio-pause").removeClass("block");
          $("#jquery_jplayer_2").jPlayer("pause");
          $(".toc_close").show();
          ...
          $.ajax({
              ...
              success: function(response) {
                  ...
                  $(response).find('resources').children().each(function() {
                      ...
                      $('#resourceloader').toggle("slide",250).append('<ul class="collection listactivity"><li class="collection-item"><a href=' + pdf + ' class="black-text ref-align" target="_blank">Link' + rid + '</a></li></ul>');
