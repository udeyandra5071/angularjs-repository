...
var quizJSON = {
    ...
    "questions": [
        { // Question 1 - Multiple Choice, Single True Answer
            ...
            "a": [
                {"option": "Yes, because James is only presenting data regarding the clinical trials and not promoting the product himself, it is acceptable for Sam to attend the meeting and promote Ipsen’s product.",      "correct": false},
                {"option": "Yes, because Sam is relatively new to the organisation, James can take him along with him to the meeting to introduce him to the physicians and Sam can then use this opportunity to talk to them about Product X.",     "correct": false},
                {"option": "No, it is not acceptable for Sam to attend the meeting and promote Ipsen’s product. Non-promotional meeting organised by MSLs with HCPs (be it individual or collective) in the presence of a sales representative is prohibited and can be done only for the purpose of making an introduction.",      "correct": true},
                {"option": "No, it is not acceptable for Sam to attend the meeting because the meeting was requested by Prof Reynolds and sales representatives are not allowed to be a part of such reactive meetings.",     "correct": false} // no comma here
            ],
            "correct": "<div class='image-tick '><img src='images/tick.png' /></div><p align='center' class='marging-left'><span>That's Correct!</span></p><p align='center' class='marging-left'></p>",
            "incorrect": "<div class='image-tick '><img src='images/tick-wrng.png' /></div><p align='center' class='marging-left'><span>That's Wrong!</span></p><p align='center' class='marging-left'></p>" // no comma here
        },
        ...
        { // Question 3 - Multiple Choice, Multiple True Answers, Select All
            ...
            "a": [
                {"option": "No, MSL’s are prohibited from making any responses to unsolicited requests for off-label information on an Ipsen product whilst in the presence of a  commercial colleague.",           "correct": true},
