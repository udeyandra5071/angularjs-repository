  ...
  $(document).ready(function() {
      ...
      // Toc's
			$(".replay-audio").bind("click",function(){
			...
			$("#responsive-icon").bind("click",function(){
				$(".menu-box").show().css({"top":"0px","z-index":"-1"}).animate({"top":"55px","z-index":"3"},500);
				
				});
				 $("#moduleclose-icon").bind("click",function(){
					  	$(".menu-box").show().css({"top":"55px","z-index":"-1"}).animate({"top":"-73px","z-index":"-1"},600);
					 });
      $(".audiotranscriptor").bind("click", function() {
          $('.transcriptor').show();
          //$(this).hide();
          $(".close_transcript").show();
          $(".transcript_loader").show().css({"bottom":"-62px","z-index":"6","overflow-y":"auto"}).animate({"bottom":"9px"},600);
      ...
      $(".close_transcript").bind("click", function() {
          ...
          $(this).fadeOut();
          $(".transcript_loader").show().css({"bottom":"9px","overflow-y":"hidden"}).animate({"bottom":"-62px","z-index":"-6"},600);
